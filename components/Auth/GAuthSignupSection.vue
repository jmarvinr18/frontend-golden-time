<template>
    <div class="is-desktop">
        <div class="container w-100 text-center position-relative cursor-pointer" style="margin-bottom:-120px" data-bs-toggle="modal" data-bs-target="#photo-modal">
            ...
            <img :src="avatarImg?avatarImg:'/images/no-avatar.jpeg'" class="object-fit-cover rounded-circle mx-auto g-shadow" style="width: 180px; height: 180px;" />
        </div>
    ...
    <div class="is-mobile">
        <div class="container w-100 text-center position-relative mt-5 cursor-pointer" style="margin-bottom:-60px" data-bs-toggle="modal" data-bs-target="#photo-modal">
            <img src="https://www.muscleandfitness.com/wp-content/uploads/2019/01/man-tire-pull-1109.jpg?quality=86&strip=all" style="width: 110px; height: 11px;" class="object-fit-cover rounded-circle mx-auto g-shadow" />

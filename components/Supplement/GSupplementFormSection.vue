<template>
    <div class="is-desktop container w-100 text-center position-relative" style="margin-bottom:-120px">
        ...
        <img :src="prodImage? prodImage:'/images/no-image.jpeg'"  style="height:180px; width: 180px;" class="cursor-pointer object-fit-cover rounded-circle mx-auto g-shadow" data-bs-toggle="modal" data-bs-target="#photo-modal" />
    </div>
    <div class="is-mobile container w-100 text-center position-relative" style="margin-bottom:-100px">
        ...
        <img :src="prodImage? prodImage:'/images/no-image.jpeg'" style="height:120px; width: 120px;" class="cursor-pointer object-fit-cover rounded-circle mx-auto g-shadow" data-bs-toggle="modal" data-bs-target="#photo-modal" />
    </div>
    <div class="w-100 rounded-lg py-5 mt-4 bg-white border border-2">
        <!-- ADD / EDIT FORM -->
        <div class="is-desktop container py-4 w-50 mx-auto">
            <SupplementGSupplementForm :img="prodImage"></SupplementGSupplementForm>
        </div>

    ...
    <div class="w-100 position-relative border-0 rounded-4 text-center g-shadow">
        ...
        <div class="is-desktop overflow-hidden rounded-lg p-1" :class="type=='taste'? 'bg-grad-1':'bg-grad-2'">
            <div class="bg-white rounded-lg">
                ...
                <button class="btn  mx-auto rounded-pill py-2 mb-3 mt-2 g-shadow" :class="type=='taste'? 'text-grad-1 btn-outline-success':'btn-outline-primary text-grad-2'" data-bs-toggle="modal" :data-bs-target="`#rating-modal-${type}`">Post a rating <i class="bi bi-arrow-up ms-2"></i></button>
            </div>
        </div>

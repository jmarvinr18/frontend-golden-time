...
export const i18n = createI18n({
    ...
    messages: {
        ...
        ja: {
            ...
            RatingSubmitted: "あなたの評価は正常に送信されました。",
            MakeSureAllFieldsHasBeenFilled: "Please make sure all required fields has been filled.",
            SupplementCreatedMsg: "サプリメントが正常に作成されました。",
            SupplementUpdatedMsg: "サプリメントは正常に更新されました。",
            SupplemenRemovedMsg: "サプリメントは正常に削除されました。",
            CommentAddedMsg: "コメントが正常に追加されました。",
            Great: "素晴らしい",
            Oops: "おっとっと！",
            WelcomeBack: "おかえり！",
